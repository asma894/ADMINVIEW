            ...
            <div x-data="{ checkboxToggle: false }">
                <label for="checkboxLabelOne"
                    ...
                    <p class="inline-block font-normal text-gray-500 dark:text-gray-400">
                        ...
                        and our <span class="text-gray-800 dark:text-white">Privacy Policy</span>
                    </p>
                </label>
            </div>
        </div>
...
<?php endif; ?>
            ...
            <div class="fixed right-6 bottom-6 z-50">
                <button
                    ...
                    <svg class="hidden fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
