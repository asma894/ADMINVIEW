                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                    ...
                    <td class="px-5 py-3">
                        <div class="flex items-center gap-3">
                            {{-- Avatar: fixed 36×36, never grows --}}
                            ...
                            <div class="min-w-0">
                                <p class="truncate font-medium text-gray-800 dark:text-white">{{ $user->name }}</p>
                                <p class="truncate text-xs text-gray-400 dark:text-gray-500">{{ $user->bio ?? '—' }}</p>
                            </div>
                        </div>
                    </td>
